    ...
    const defaultOptions = {
      ...
      purposes: {
        ...
        newWindow: {
          ...
          redundantStrings: /(window|\stab)/, // Screen reader text will not be inserted if present
        },
        ...
        document: {
          ...
          redundantStrings: /(download|file|word|excel|pdf|xls|powerpoint|docx|([.(]|\s)(ppt|doc))/,
        },
